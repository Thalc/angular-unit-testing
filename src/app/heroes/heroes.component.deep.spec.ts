...
describe('HeroesComponent (deep)', ()=>{
    ...
    it('should render each hero as a HeroComponent', () =>{
        ...
        heroComponentDEs[0].componentInstance.hero = HEROES[0];
        expect(heroComponentDEs[0].componentInstance.hero).toBe(HEROES[0]);
    })
    ...
    it('should add a new hero to the hero list when the add button is clicked', () => {
        ...
        expect(heroComponentDEs[2].componentInstance.hero.name).toBe(name);
    })
    ...
    it('should have the correct route for the first hero', () => {
        ...
        const heroComponentDEs = fixture.debugElement.queryAll(By.directive(HeroComponent));
        const routerLink = heroComponentDEs[0].query(By.directive(RouterLinkDirectiveStub)).injector.get(RouterLinkDirectiveStub);
